...
const Trigger = union(enum) {
    ...
    first_craft: usize, // id of recipe that was crafted
};
```
...
- **first_craft**: When an item (e.g. constructor) is crafted for the first
  time.
